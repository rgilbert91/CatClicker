const cat1 = { name: "Cat1", img: "cat1.jpg", clicks: 0 };
const cat2 = { name: "Cat2", img: "cat2.jpg", clicks: 0 };
const cat3 = { name: "Cat3", img: "cat3.jpg", clicks: 0 };
const cat4 = { name: "Cat4", img: "cat4.jpg", clicks: 0 };
const cat5 = { name: "Cat5", img: "cat5.jpg", clicks: 0 };
